    ...
    return (
      <ul class="list-container">
        {this.props.items.map(function(item) {
          return (
            <li className="list-item" data-category={item} key={item}>
              <div class="company-name">{item}</div>
              <button class="cart-button" onClick={() => clickHandler(item)}>
                Add to cart
              </button>
            </li>
          );
          ...
          <form>
            ...
            <label class="text-style">
              <input
                ...
                type="text"
                name="name"
                placeholder="Magic Leap"
                onChange={this.search.bind(this)}
              />
            </label>
          </form>
          <div class="search-results">
            <p class="text-style" id="text-style-black">
              Results
            </p>
            <List
